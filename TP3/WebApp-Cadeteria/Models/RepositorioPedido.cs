        ...
        public List<Pedidos> getAll()
        {
            ...
            using(SQLiteConnection conexion = new SQLiteConnection(connectionString))
            {
                ...
                using(SQLiteDataReader DataReader = command.ExecuteReader())
                {
                    ...
                    {
                        Pedidos pedido = new Pedidos(Convert.ToInt32(DataReader["id_pedido"]),DataReader["observacion"].ToString(), DataReader["estado_pedido"].ToString(), DataReader["id_cliente"].ToString(), DataReader["nombre_cliente"].ToString(), DataReader["direccion_cliente"].ToString(), DataReader["telefono_cliente"].ToString());
